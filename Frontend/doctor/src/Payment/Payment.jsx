            ...
            <div className="payment-process">
                ...
                <div className="payment-types">
                    <div className="payment-methods">
                        <button className={credit?"pink":"orange"}  onClick={() => { setcredit(true); setdebit(false); setpay("Credit Card") }}>Credit Card</button>
                        <button  className={debit?"pink":"orange"}  onClick={() => { setdebit(true); setcredit(false); setpay("Debit Card") }}>Debit Card</button>
